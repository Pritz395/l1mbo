"""Tests for Limbo messaging and notification system."""
import asyncio
import pytest
from unittest.mock import Mock, AsyncMock

import mcp.types
from limbo.messaging import (
    LimboMessageHandler,
    MessageRouter,
...
class TestLimboMessageHandler:
    """Test LimboMessageHandler functionality."""
...
class TestIntegration:
    ...
    async def test_end_to_end_flow(self):
        ...
        class TestMessageHandler(LimboMessageHandler):
