...
from limbo.util.transport import get_transport_for_command, get_transport_for_uri
from limbo.util.transports import NoValidatePythonStdioTransport, NoValidateNodeStdioTransport
...
class TestGetTransportForUri:
    ...
    @patch('limbo.util.transport.infer_transport')
