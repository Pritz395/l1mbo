"""Kit management for Limbo - bundling related MCP servers."""
import json
import logging
...
from .settings import ConfigManager, ServerConfig, LimboConfig, KitInfo
...
class KitManager:
    ...
    def load_kits_from_config(self, config: 'LimboConfig') -> None:
    ...
    def load_kit_to_config(self, kit_name: str, config: 'LimboConfig') -> tuple[bool, str]:
    ...
    def unload_kit_from_config(self, kit_name: str, config: 'LimboConfig') -> tuple[bool, str]:
