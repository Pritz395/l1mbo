"""Response model for Limbo tools.
"""
import json
...
class LimboResponse(BaseModel):
    """Standardized response format for Limbo tools.
    ...
    model_config = ConfigDict(
        ...
        extra="allow",
        json_schema_extra={
            "description": "Standardized response format for Limbo tools.",
            "examples": [
                {
    ...
    @classmethod
    def success(cls, output: Any) -> "LimboResponse":
        """Create a success response with output data."""
        return cls(output=output)

    @classmethod
    def error(cls, error: str | dict | list) -> "LimboResponse":
