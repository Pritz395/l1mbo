"""Limbo FastMCP client wrapper with authentication and proxy support."""
...
from .messaging import LimboMessageHandler


class LimboClient(ProxyClient):
    """Limbo-specific client with authentication and proxy support.

    This client is designed for external code that needs to talk to Limbo servers.
    ...
    def __init__(
        ...
        **kwds,
        ...
        """Initialize Limbo client with JWT authentication and proxy support.
        ...
        Args:
            ...
            *args: Additional positional arguments for ProxyClient
            ...
            transparent: Enable transparent proxy mode (default: True for Limbo)
