"""Configuration reload functionality for Limbo server."""
import asyncio
import json
import logging
...
from .settings import LimboConfig, ServerConfig
...
class ConfigChange:
    ...
    old_config: LimboConfig
    new_config: LimboConfig
...
class ConfigReloader:
    ...
    def __init__(self, config_path: Path, reload_callback: ReloadCallback):
        ...
        self._last_config: LimboConfig | None = None
    ...
    def update_cached_config(self, config: LimboConfig) -> None:
    ...
    def get_cached_config(self) -> LimboConfig | None:
    ...
    async def reload_config(self) -> ConfigChange | None:
        ...
        async with self._reload_lock:
            try:
                ...
                old_config = self._last_config or LimboConfig()
    ...
    def _load_config(self) -> LimboConfig | None:
    ...
    def _detect_changes(self, old_config: LimboConfig, new_config: LimboConfig) -> ConfigChange:
    ...
    def _validate_config(self, config: LimboConfig) -> bool:
...
class ReloadManager:
    ...
    @property
    def cached_config(self) -> LimboConfig | None:
        """Get the cached configuration if available."""
