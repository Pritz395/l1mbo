...
from limbo.util.transport import get_transport_for_command_string, is_connection_string_url
...
class BrowserConnection:
    ...
    async def connect(self, env_pass: bool = False, env_vars: dict[str, str] | None = None) -> bool:
        ...
        jwt = os.getenv("LIMBO_JWT", os.getenv("MBRO_JWT", os.getenv("MCP_JWT", None)))
