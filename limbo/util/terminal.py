...
def print_startup_banner():
    ...
    # ascii_art = pyfiglet.figlet_format("LIMBO", font="big")
    # ascii_art = pyfiglet.figlet_format("LIMBO", font="isometric3")
    # ascii_art = pyfiglet.figlet_format("LIMBO", font="whimsy")

    # ascii_art = art.text2art("LIMBO", font="cricket")
    # ascii_art = art.text2art("LIMBO", font="diamond")
    # ascii_art = art.text2art("LIMBO", font="tarty1")
    ascii_art = art.text2art("LIMBO", font="isometric3")
