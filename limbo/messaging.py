"""Message handling for Limbo MCP aggregation.
...
class LimboMessageHandler(MessageHandler):
    """Limbo-specific message handler that coordinates multiple backend servers.

    This handler can be used with LimboClient to receive aggregated notifications
    from all backend MCP servers managed by a Limbo instance.
    """
    ...
    def __init__(
        ...
        """Initialize the Limbo message handler.
